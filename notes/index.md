...
* Module 2 - Real-Time Mechatronic Systems
    ...
    * Lecture 13 - GPIO Port Pin Circuitry
        * Topics
    ...
    * Lecture 16 - Introduction to IMUs, Euler Angles, and Quaternions
        * Reading
...
* Module 3 - Autonmous Systems and Project Integration
    ...
    * Lecture 19 - Discretization Techniques
        * Reading
            ...
            * [[reference_digital_filters|Digital Filters]]
            * [[reference_discrete_PID|Discrete PI Implementation]]
            * [[reference_matrix_exponential|Matrix Exponential]]
        * Topics
            * \[\[Discretization Techniques\]\]
    * Lecture 20 - Observer Fundamentals
        * Reading
    ...
    * Lecture 21 - Reliability and Robustness in Engineering
        * Topics
            * \[\[Reliability and Robustness in Engineering\]\]
    * Lecture 22 - Trajectory Planning
        * Topics
            * \[\[Trajectory Planning\]\]
    * Lecture 23 - Switch Bounce Phenomenon and  Debounce Techniques
        * Reading
