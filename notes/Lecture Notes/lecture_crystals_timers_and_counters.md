...
![Schematic snippets for an RC oscillator and a Pierce oscillator. Also shown is a graph of the typical output from an oscillator.|700](images/oscillator_output.svg)
