...
> [!table]
> MicroPython `utime` functions used for software timing.
>
> | Function       | Purpose                                                                                           |
> | -------------- | ------------------------------------------------------------------------------------------------- |
...
> [!block_listing] Scheduling repeated work with tick functions
> ``` python
...
> [!note]
> If even you use the microsecond ticks function you should *not* expect microsecond precision with this timing method. For lower latency timing at the cost of additional overhead and additional coding restrictions you may consider timer callbacks instead.
