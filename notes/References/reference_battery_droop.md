...
![A block diagram representation of a closed loop controller with an extra dynamic gain on the controller output.|700](images/ControlLoopDiagrams_Battery_Compensation.svg)
