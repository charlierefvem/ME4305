...
> The stable region in the s-domain is the left half-plane.
...
> The stable region in the z-domain is inside the unit circle.
...
> [!table]
> Ideal and approximate continuous-to-discrete transforms.
>
...
> Forward-difference approximation between consecutive samples.
...
> Backward-difference approximation between consecutive samples.
...
> Trapezoidal approximation between consecutive samples.
