...
| ------------------- | ------------- | ------------ | ---------------------- | ---------- | ------- | -------- | --------- | ----------- |
| Primary / Waveforms |        1.5 px | Black        | Plain                  | -          |   100 % | Top      | Arrow 2   |        50 % |
| Callout Boxes       |        1.0 px | #808080      | Dashed (dash=2, gap=4) | #F2F2F2    |   100 % | -        | -         |             |
| Leaders             |        1.0 px | Black        | Plain                  | -          |   100 % | -        | Arrow 13  |        75 % |
| Gridlines           |       0.25 px | #CCCCCC      | Plain                  | -          |   100 % | Bottom   | -         |             |
...
| ------------------------------ | ---- | ---------------------------------- |
| Titles / Subtitles             |   16 | CMU Sans Serif (Bold)              |
| Axes Labels / Legends          |   12 | CMU Sans Serif (Medium)            |
| Units / Words                  |   12 | CMU Sans Serif (Medium)            |
